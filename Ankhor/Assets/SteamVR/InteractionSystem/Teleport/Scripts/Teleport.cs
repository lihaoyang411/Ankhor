...
namespace Valve.VR.InteractionSystem
{
	...
	public class Teleport : MonoBehaviour
    {
        ...
        // Caleb Stuff
        private float attemptTeleportDistance = 0.0f;
        private float allowedTeleportDistance;
		...
		void Start()
        {
            ...
            allowedTeleportDistance = arcDistance;
            setStamina = false;
		}
		...
		private void UpdatePointer()
		{
            ...
            attemptTeleportDistance = Vector3.Distance(pointerStart, pointerEnd);

            if ( hitTeleportMarker != null && attemptTeleportDistance <= allowedTeleportDistance) //Hit a teleport marker
			{
            ...
            else if(attemptTeleportDistance > allowedTeleportDistance)
            {
                destinationReticleTransform.gameObject.SetActive(false);
...
#if (UNITY_5_4)
                pointerLineRenderer.SetColors( Color.cyan, Color.cyan );
#else
                pointerLineRenderer.startColor = Color.cyan;
                pointerLineRenderer.endColor = Color.cyan;
#endif
		...
		{
			if ( visible && !teleporting && attemptTeleportDistance <= allowedTeleportDistance )
			{
        ...
        // Caleb-added code
        public void setTeleportStamina(float staminaPercent)
        {
            allowedTeleportDistance = staminaPercent * arcDistance;
            setStamina = true;
        }
        ...
        public float getTeleportDistance()
        {
            ...
            {
                bTeleported = false;
                return attemptTeleportDistance;
            }
