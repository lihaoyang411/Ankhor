...
public class PlayerHandL : MonoBehaviour {
    ...
    private void OnTriggerEnter(Collider other) {
        ...
        // Debug.Log("On a trigger");          // now check to see 
        // what type of object it is           if (other.tag == "Handle") {
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.tag == "Flashlight")
        {
            ...
            if (!holdingObject)
            {
                ...
                // switch to it
                if (HandR.GetComponent<PlayerHandL>().holdingObject)
                {
                    OnStayPickupAction(other);

                    HandR.GetComponent<PlayerHandL>().holdingObject = false;

                    HandR.GetComponent<PlayerHandL>().ItemOnHand = null;
                }
