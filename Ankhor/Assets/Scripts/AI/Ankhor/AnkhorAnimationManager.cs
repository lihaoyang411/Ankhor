...
public class AnkhorAnimationManager : MonoBehaviour
{

    private Animator animator;

    private AnkhorAnimationStates State;
    ...
    private void AnimateState()
    {
        ...
        switch (State)
        {
            case AnkhorAnimationStates.SEARCHING:
                animator.SetBool("isSearching", true);
                break;
            case AnkhorAnimationStates.WALKING:
                animator.SetBool("isSearching", false);
                animator.SetBool("isAttacking", false);
                break;
            case AnkhorAnimationStates.ATTAKING:
    ...
    public void UpdateState(AnkhorAnimationStates state)
    {
        State = state;
    }
    ...
    private void Defrost()
    {
        if (currentFrozenTime <= 0.0f)
        {
            ...
            this.GetComponent<AnkhorAIManager>().DeFrosted();
...
public enum AnkhorAnimationStates
{
